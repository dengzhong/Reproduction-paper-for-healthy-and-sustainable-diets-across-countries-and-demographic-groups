...
$setglobal OUT_GDX "/Users/zhongcideng/Desktop/dengzc/2026/paper/national age specific/Code/output data/optimized model output/base_Costmin_new.gdx"
...
dvar..
* modified for sex dimension: Demand is Demand(j,age,sex), weighted by PopAge(age,sex)
    sum((j,age,sex), Demand(j,age,sex) / wasteRatio(j) * price_food(j) * PopAge(age,sex)) / totalPop =e= Deviation;
