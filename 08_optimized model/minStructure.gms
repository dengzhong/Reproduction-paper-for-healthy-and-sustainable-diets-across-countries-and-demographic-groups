...
$setglobal OUT_GDX "/Users/zhongcideng/Desktop/dengzc/2026/paper/national age specific/Code/output data/optimized model output/base_Structuremin_new.gdx"
...
dvar..
  sum((j,age,sex)$(DemandBase(j,age,sex) > 0),
      sqr((Demand.l(j,age,sex) - DemandBase(j,age,sex)) / DemandBase(j,age,sex))) =e= Deviation;
...
loop(i$(not excludedCountry(i)),
    ...
    solve mymodel minimizing Deviation using QCP;
