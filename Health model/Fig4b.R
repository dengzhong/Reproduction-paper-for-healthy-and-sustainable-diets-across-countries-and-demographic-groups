...
food_group_levels <- c("Fruits", "Vegetables", "Nuts", "Legumes", "Processed meat","Red meat","Whole grains")
food_group_labels <- c(
  "Fruits" = "Fruits",
  "Vegetables" = "Vegetables",
  "Nuts" = "Nuts",
  "Legumes" = "Legumes",
  "Processed meat" = "Prcd_meat",
  "Red meat" = "Redmeat",
...
plot_df <- deaths_df %>%
  ...
  mutate(
    income_group = case_when(
      income_code == "High income" ~ "High",
      income_code == "Upper-middle income" ~ "Upper-middle",
      income_code == "Lower middle income" ~ "Lower-middle",
      income_code == "Low income" ~ "Low",
      TRUE ~ NA_character_
    )
  ) %>%
